...
const reasons = [
  { icon: Sparkles,        title: "Calidad profesional",    desc: "Materiales premium y acabados impecables en cada pieza." },
  { icon: Zap,             title: "Entrega rápida",         desc: "Producción ágil sin sacrificar la calidad de tu trabajo." },
  { icon: Heart,           title: "Atención personalizada", desc: "Te acompañamos desde la idea hasta el producto final." },
  { icon: BadgeDollarSign, title: "Precios competitivos",   desc: "Mejor relación calidad-precio del mercado local." },
];
...
export function HomePage() {
  ...
  useEffect(() => {
    api.get<Product[]>("/products").then(({ data }) => setFeatured(data.slice(0, 6)));
  }, []);
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-white">
        <div
          ...
          style={{ background: "radial-gradient(60% 50% at 70% 30%, oklch(0.58 0.22 25 / 0.4), transparent 70%)" }}
        />
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 md:grid-cols-2 md:items-center md:gap-12 md:px-6 md:py-28">
          <div>
            ...
            <p className="mt-5 max-w-xl text-balance text-base text-white/75 md:text-lg">
              ...
              Desde una tarjeta hasta un banner gigante.
            </p>
          ...
          <div className="relative">
            ...
            <img src={heroImg} alt="Productos impresos JTV Multiservice"
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">Todo lo que necesitas para destacar tu marca o evento.</p>
          </div>
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((s) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-muted-foreground">Producción profesional con materiales de primera calidad.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-secondary py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">Nos comprometemos con tu marca como si fuera nuestra.</p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {reasons.map((r) => (
              <div key={r.title} className="rounded-2xl bg-card p-6 shadow-card">
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="overflow-hidden rounded-3xl bg-gradient-brand p-10 text-brand-foreground shadow-elegant md:p-14">
            <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                <h2 className="text-3xl font-bold md:text-4xl">¿Listo para imprimir tu próxima idea?</h2>
                <p className="mt-2 text-white/80">Cuéntanos tu proyecto y recibe una cotización personalizada.</p>
              </div>
              <Link to="/contacto"
